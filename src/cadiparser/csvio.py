...
class CSVtools:
    ...
    def write_csv_day(self, input_dir: Path, extension_str: str, output_dir: str | Path, raw_reader: DataReader, multithread=False, backend='threading'):
        ...
        files_list, all_metadata, all_heights, all_freqs, all_freq_list, all_dopshifts, all_sensors = raw_reader.read_raw_data_dir(input_dir, extension_str, multithread, backend)
